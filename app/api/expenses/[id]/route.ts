  ...
  try {
    ...
    const updated = await prisma.expense.update({
      ...
      data: {
        ...
        invoiceUrl: payload.invoiceUrl === undefined ? existing.invoiceUrl : (payload.invoiceUrl || null),
        invoiceFileName: payload.invoiceFileName === undefined ? existing.invoiceFileName : (payload.invoiceFileName || null),
        invoiceMimeType: payload.invoiceMimeType === undefined ? existing.invoiceMimeType : (payload.invoiceMimeType || null),
